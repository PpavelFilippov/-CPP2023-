...
void write(const std::vector<double>& line) {
...
double discriminant(const std::vector <double>& line) {
    int d = line.size();
    if (d == 0)
        return 0;
...
double search(const double& discriminant, const std::vector<double>& line) {
